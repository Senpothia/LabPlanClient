...
public class FicheViewPdf extends AbstractPdfView {
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		try {
			...
			Image entete = Image.getInstance("/labplan/src/main/resources/static/images/bandeau_entreprise1.png");
			// Image entete =
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		PdfPCell cellDate2 = new PdfPCell(new Phrase(fiche.getDate(), FontFactory.getFont(FontFactory.TIMES, 10)));
