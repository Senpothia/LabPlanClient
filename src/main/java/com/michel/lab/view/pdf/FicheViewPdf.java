...
public class FicheViewPdf extends AbstractPdfView {
	...
	//	cell = new PdfPCell(new Phrase("Fiche d'anomalie technique"));
		...
		PdfPCell cellAuteur2 = new PdfPCell(new Phrase(fiche.getNomAuteur(),
		...
		PdfPCell cellService = new PdfPCell(new Phrase("Service:",
				 FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
		cellAuteur.setColspan(1);
		cellAuteur.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
		table.addCell(cellService);
		
		PdfPCell cellService2  = new PdfPCell(new Phrase("Labo",
				 FontFactory.getFont(FontFactory.TIMES, 10)));
		...
		PdfPCell cellOrgane2 = new PdfPCell(new Phrase(fiche.getObjet(),
				 FontFactory.getFont(FontFactory.TIMES, 10)));
		...
		PdfPCell cellGravite = new PdfPCell(new Phrase(String.valueOf(fiche.getNiveau()),
				 FontFactory.getFont(FontFactory.TIMES, 10)));
		cellGravite.setColspan(2);
		cellGravite.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
		table.addCell(cellGravite);
		
		PdfPCell cellGravite2 = new PdfPCell(new Phrase(String.valueOf(fiche.getNiveau()),
				 FontFactory.getFont(FontFactory.TIMES, 10)));
